...
import com.reactive.graphql.microservices.graphqlplayground.lec07.customer.order.model.Customer;
...
public class CustomerService {
    ...
    public Flux<Customer> allCustomers() {
        return this.customerFlux
                ...
                .doOnNext(customer -> log.info("Emitted customer name : {}", customer.getName()));
    }
}